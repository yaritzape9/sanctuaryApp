      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="lg:sticky lg:top-24">
          ...
          <p className="text-neutral-400 leading-relaxed mb-8">
            Join Sanctuary to report sightings, set up your panic button, and
            stay informed in real time. Your safety is our priority.
          </p>
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-3">
              <span className="text-sanctuary-accent mt-0.5">→</span>
              <p className="text-sm text-neutral-400">Real-time ICE sighting alerts near you</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-sanctuary-accent mt-0.5">→</span>
